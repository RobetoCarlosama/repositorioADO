    ...
    <section class="panel">
        <div class="table-responsive">
           ...
           <a class="btn-sm btn-primary"  data-target="#exampleModal" data-toggle="modal">Nuevo <i class="icon_plus_alt2" data-target="#exampleModal" data-toggle="modal"></i></a>
            <br />            
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_rol" DataSourceID="sqldsRoles" CssClass="table table-striped table-advance table-hover" GridLines="None" HorizontalAlign="Center">
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButtonActualizar" runat="server" CausesValidation="True" CommandName="Update" Text="Actualizar" ValidationGroup="actualizaRol" CssClass="btn btn-success"></asp:LinkButton>
                        ...
                        <ItemTemplate>
                            ...
                            &nbsp;<asp:LinkButton ID="LinkButtonEliminar" runat="server" CausesValidation="False" CommandName="Delete" OnClientClick="return confirm('¿Seguro que desea eliminar el registro?');" Text="Eliminar" CssClass="btn btn-danger"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
