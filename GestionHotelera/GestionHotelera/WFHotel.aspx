    ...
    <section class="panel">
        <div class="table-responsive">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" AutoGenerateRows="False" DataKeyNames="id_hotel" DataSourceID="sqldsHoteles" DefaultMode="Insert" CssClass="table table-striped table-advance table-hover" GridLines="None" HorizontalAlign="Center">
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="seleccione la provincia" SortExpression="id_provincia">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="direccion" SortExpression="direccion_hotel">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="email" SortExpression="email_hotel">
                        <EditItemTemplate>
            ...
            <asp:SqlDataSource ID="sqldsHoteles" runat="server" ConflictDetection="CompareAllValues" 
                ...
                SET [id_provincia] = @id_provincia, [nombre_hotel] = @nombre_hotel, [ruc_hotel] = @ruc_hotel, [direccion_hotel] = @direccion_hotel, [telefono_hotel] = @telefono_hotel, [email_hotel] = @email_hotel, [creacion_hotel] = @creacion_hotel, [actualizacion_hotel] = GETDATE(), [estado_hotel] = @estado_hotel 
           ...
           <a class="btn-sm btn-primary"  data-target="#exampleModal" data-toggle="modal">Nuevo <i class="icon_plus_alt2" data-target="#exampleModal" data-toggle="modal"></i></a>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_hotel" DataSourceID="sqldsHoteles" CssClass="table-responsive table-striped table-advance table-hover" GridLines="Vertical" HorizontalAlign="Center">
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButtonActualizar" runat="server" CommandName="Update" Text="Actualizar" CssClass="btn btn-success" ValidationGroup="actualizaHotel"></asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButtonCancelar" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancelar" CssClass="btn btn-primary"></asp:LinkButton>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButtonEditar" runat="server" CausesValidation="False" CommandName="Edit" Text="Editar" CssClass="btn btn-primary"></asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButtonEliminar" runat="server" CausesValidation="False" CommandName="Delete" Text="Eliminar" CssClass="btn btn-danger" OnClientClick="return confirm('¿Seguro que desea eliminar el registro?');"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="telefono" SortExpression="telefono_hotel">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="creacion" SortExpression="creacion_hotel">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="actualizacion" SortExpression="actualizacion_hotel">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="estado" SortExpression="estado_hotel">
                        <EditItemTemplate>
